...
7. Assign the issue to the best team member(s) based on repository ownership signals (CODEOWNERS, prior issue ownership, and recent work in the affected area).
